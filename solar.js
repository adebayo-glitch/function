...
console.log(solarSystem[7].moons.at(1))
// 3. Add a new moon called "Endor" to Venus' moons array.

console.log(solarSystem[1].moons.unshift("Endor"))
...
console.log(solarSystem.push({
    name: "Pluto",
    ringSystem: true,
    moons: ["charion"]
}))
// 5. Add a new key-value pair to the the Earth object: the key should be 'diameter', and the value should be Earth's diameter in miles represented as a strisolar
solarSystem[2].diameter = "strisolar"
...
for (let item of solarSystem){
    // console.log(item)
    if(item.ringSystem){
        console.log("Ring system are true", item)
    }
}
//////////////////////////////
...
const satelliteSum = Number(system.jupiter.satellites) +  system.saturn.satellites + system.uranus.satellites + system.neptune.satellites;
